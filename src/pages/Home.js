    ...
    {/* <a href="#" class="btn btn-primary">Go somewhere</a> 
      ...
      <h1 id='sports'>Activites in the city of Cincinnati</h1>
        ...
        <div className="row">
          <div className="col-md-3">
            <div className="card">
              <img src={findlaymarket} className="card-img-top pictures" alt="..." />
              <div className="card-body">
                <h5 className="card-Text">Findlay Market</h5>
          ...
          <div className="col-md-3">
            <div className="card">
              <img src={americansign} className="card-img-top pictures" alt="..." />
              <div className="card-body">
               <h5 className="card-Text">American Sign Museum</h5>
                <p className="card-Text">
          ...
          <div className="col-md-3">
            <div className="card">
              <img src={zooanimal} className="card-img-top pictures" alt="..." />
              <div className="card-body">
                <h5 className="card-Text"> the Cincinnati Zoo & Botanical Garden</h5>
                <p className="card-Text">
          ...
          <div className="col-md-3">
            <div className="card">
              <img src={kingsisland} className="card-img-top pictures" alt="..."/>
              <div className="card-body">
                <h5 className="card-Text">Kings Island</h5>
                <p className="card-Text">
        ...
        <div className="row">
          <div className="col-md-3">
            <div className="card">
              <img src={reds} className="card-img-top pictures" alt="..." />
              <div className="card-body">
                <h5 className="card-Text">Cincinnati Reds</h5>
                <p className="card-Text">
          ...
          <div className="col-md-3">
            <div className="card">
              <img src={bangels} className="card-img-top pictures" alt="..." />
              <div className="card-body">
                <h5 className="card-Text">The Bangels</h5>
                <p className="card-Text">
          ...
          <div className="col-md-3">
            <div className="card">
              <img src={fcc} className="card-img-top pictures" alt="..." />
              <div className="card-body">
                <h5 className="card-Text">FC Cincinnati</h5>
                <p className="card-Text">
                The Cincinnati Bengals are a professional American football team based in Cincinnati. The Bengals compete in the National Football League as a member club of the league's American Football Conference North division.
                </p>
          ...
          <div className="col-md-3">
            <div className="card">
              <img src={cyclone} className="card-img-top" alt="..." />
              <div className="card-body">
                <h5 className="card-Text">Cincinnati Cyclone's</h5>
                <p className="card-Text">
